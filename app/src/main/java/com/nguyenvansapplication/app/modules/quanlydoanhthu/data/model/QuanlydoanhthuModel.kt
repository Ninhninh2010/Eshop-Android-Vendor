package com.nguyenvansapplication.app.modules.quanlydoanhthu.`data`.model

import com.nguyenvansapplication.app.R
import com.nguyenvansapplication.app.appcomponents.di.MyApp
import kotlin.String

data class QuanlydoanhthuModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtQunldoanht: String? = MyApp.getInstance().resources.getString(R.string.msg_qu_n_l_doanh_t)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtGroupFour: String? = MyApp.getInstance().resources.getString(R.string.lbl_giamgia)
  ,
  /**
   * TODO Replace with dynamic value
   */
